...
st.header(":green[Heart Disease Prediction using ML]")
...
st.image(image2,'')
image3=Image.open("C:\\Users\hp\\Desktop\\placement\\heart disease prediction\\heart.jpg")
st.image(image3,'')

st.header(":green[Facts about Heart disease]")
image0=Image.open("C:\\Users\\hp\\Desktop\\placement\\heart disease prediction\\image0.jpeg")
st.image(image0,'')
st.write("")
image4=Image.open("C:\\Users\\hp\\Desktop\\placement\\heart disease prediction\\heart1.jpg")
st.image(image4,'')
...
df=pd.read_csv("C:\\Users\\hp\\Desktop\\placement\\heart disease prediction\\heart.csv")
st.write(df)
